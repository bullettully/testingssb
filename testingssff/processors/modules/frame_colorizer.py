...
from testingssff import config, content_analyser, inference_manager, logger, process_manager, state_manager, wording
...
from testingssff.processors.types import FrameColorizerInputs
from testingssff.program_helper import find_argument_group
from testingssff.thread_helper import thread_semaphore
from testingssff.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from testingssff.vision import read_image, read_static_image, unpack_resolution, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		testingssff.jobs.job_store.register_step_keys([ 'frame_colorizer_model', 'frame_colorizer_blend', 'frame_colorizer_size' ])
