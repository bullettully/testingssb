...
from testingssff.common_helper import create_int_metavar
from testingssff.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from testingssff.face_analyser import get_many_faces, get_one_face
from testingssff.face_helper import paste_back, warp_face_by_face_landmark_5
from testingssff.face_masker import create_occlusion_mask, create_static_box_mask
from testingssff.face_selector import find_similar_faces, sort_and_filter_faces
from testingssff.face_store import get_reference_faces
from testingssff.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from testingssff.processors import choices as processors_choices
from testingssff.processors.live_portrait import create_rotation, limit_expression
from testingssff.processors.types import ExpressionRestorerInputs, LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw
from testingssff.program_helper import find_argument_group
from testingssff.thread_helper import conditional_thread_semaphore, thread_semaphore
from testingssff.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from testingssff.vision import read_image, read_static_image, read_video_frame, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		testingssff.jobs.job_store.register_step_keys([ 'expression_restorer_model', 'expression_restorer_factor' ])
