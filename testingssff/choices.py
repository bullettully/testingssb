...
download_provider_set : DownloadProviderSet =\
{
	'github':
	{
		...
		'path': '/testingssff/testingssff-assets/releases/download/{base_name}/{file_name}'
	},
	'huggingface':
	{
		'urls':
		...
		'path': '/testingssff/{base_name}/resolve/main/{file_name}'
	}
}
