...
def render() -> None:
	...
	EXECUTION_QUEUE_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(testingssff.choices.execution_queue_count_range),
		minimum = testingssff.choices.execution_queue_count_range[0],
		maximum = testingssff.choices.execution_queue_count_range[-1]
	)
